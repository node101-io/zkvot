...
import RightArrow from "@/public/general/icons/right-arrow";
...
const Button: FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      className={
        className +
        ` max-w-fit z-[2] group relative inline-flex items-center px-4 py-2 rounded-full font-medium overflow-hidden transition-all duration-300 ease-in-out ${
