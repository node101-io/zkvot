...
import VotingStep from '@/app/vote/(steps)/1-VotingStep.jsx';
import SubmissionStep from '@/app/vote/(steps)/2-SubmissionStep.jsx';
import ResultPage from '@/app/vote/(steps)/3-ResultPage.jsx';

import ProgressBar from '@/app/vote/(partials)/ProgressBar.jsx';
