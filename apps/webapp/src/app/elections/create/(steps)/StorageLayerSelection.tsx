...
import { StorageLayerDetails } from '@/utils/constants.jsx';
...
export default ({ onPrevious, onNext, initialData }: {
  ...
  const [selectedStorageLayer, setSelectedStorageLayer] = useState<types.StorageLayerPlatformCodes | null>(null);
        ...
        <div className={`grid grid-cols-1 sm:grid-cols-2 gap-4 w-full`}>
          {Object.keys(StorageLayerDetails).map((layer, index) => (
            <div
              ...
              onClick={() => setSelectedStorageLayer(layer as types.StorageLayerPlatformCodes)}
            >
              <div className='w-[160px] h-[160px] flex-shrink-0 rounded-[12px] mr-4 flex items-center justify-center'>
                {StorageLayerDetails[layer as keyof typeof StorageLayerDetails].logo || (
              ...
              <div className='flex flex-col h-full justify-between'>
                ...
                <p className='text-[16px] mb-2'>{StorageLayerDetails[layer as keyof typeof StorageLayerDetails].description}</p>
