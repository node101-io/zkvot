...
import DeleteIcon from "@/public/general/icons/delete";
import EditIcon from "@/public/general/icons/edit";
import PlusIcon from "@/public/general/icons/plus";
      ...
      <div>
        <div className="flex flex-col space-y-6 p-6 bg-[#121315] rounded-lg w-full max-w-4xl mb-4">
          ...
          <div className="flex flex-col text-sm space-y-4 w-full pt-12">
            ...
            <ChoiceInput choices={choices} setChoices={setChoices} />
          </div>
        </div>
