...
import Face1SVG from "@/public/howitworks/face-1.svg";
import Face2SVG from "@/public/howitworks/face-2.svg";
import Face3SVG from "@/public/howitworks/face-3.svg";
import Face4SVG from "@/public/howitworks/face-4.svg";
import WhyZkProof from "@/public/howitworks/why-zk-proofs.svg";
import BlueQuestionMark from "@/public/howitworks/blue-question-mark.svg";
import FacesCircle from "@/public/howitworks/faces-circle.svg";
import ThinkingFaces from "@/public/howitworks/thinking-faces.svg";
import VotesMinaAmount from "@/public/howitworks/votes-mina-amount.svg";
import AllCounters from "@/public/howitworks/all-counters.svg";
import FacesLine from "@/public/howitworks/faces-line.svg";
      ...
      <div className="w-[1280px] flex flex-col justify-center items-center">
        <div className="mt-14 w-full flex flex-col">
          <motion.div
            ...
            animate="visible"
          >
            <motion.h1 className="text-primary text-[64px]" variants={fadeInUp}>
          ...
          >
            ...
            >
              <div className="min-w-[301px] min-h-[208px]">
                <Image src={Face1SVG} alt="Face 1" width={301} height={208} />
              </div>
            ...
            >
              <div className="relative w-[600px] h-[170px]">
                ...
                <div className="absolute bottom-0 right-0">
                  <Image src={Face2SVG} alt="Face 2" width={240} height={140} />
                </div>
              </div>
            </motion.div>
            <motion.div
            ...
            >
              <div className="absolute w-[278px] h-[217px] top-0 left-0">
                <Image src={Face3SVG} alt="Face 3" width={278} height={217} />
              </div>
              <div className="mb-4">
              ...
              <div className="absolute w-[326px] h-[132px] bottom-0 right-0">
                <Image src={Face4SVG} alt="Face 4" width={326} height={132} />
              </div>
            </motion.div>
          </motion.div>
