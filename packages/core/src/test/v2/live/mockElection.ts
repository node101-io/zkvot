...
const {
  electionContractPk: electionPrivKey,
  electionControllerPk: electionControllerPk,
  electionContractInstance,
} = await deploy(
  currentSlot,
  currentSlot + 10,
...
const actions = await Mina.fetchActions(electionPrivKey.toPublicKey());
